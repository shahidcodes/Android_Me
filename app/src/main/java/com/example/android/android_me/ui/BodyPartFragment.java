...
public class BodyPartFragment extends Fragment {
    ...
    private final String KEY_IMAGE_INDEX = "image_index";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            mImageIds = savedInstanceState.getIntegerArrayList(KEY_IMAGE_LIST);
            mListIndex = savedInstanceState.getInt(KEY_IMAGE_INDEX);
        }
    ...
    public void onSaveInstanceState(Bundle outState) {
        outState.putIntegerArrayList(KEY_IMAGE_LIST, (ArrayList<Integer>) mImageIds);
        outState.putInt(KEY_IMAGE_INDEX, mListIndex);
    }
}
